...
import 'package:news_360/models/article_model.dart';
import 'package:news_360/models/category_model.dart';
import 'package:news_360/models/slider_model.dart';
import 'package:news_360/pages/all_news.dart';
import 'package:news_360/pages/article_view.dart';
import 'package:news_360/pages/category_news.dart';
import 'SavedArticlesPage.dart';

import 'package:news_360/services/data.dart';
import 'package:news_360/services/news.dart';
import 'package:news_360/services/slider_data.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // Navigate to the SearchPage when the FAB is pressed
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => SearchPage()), // Replace with your page
          );
        },
        backgroundColor: Color(0xFFB2B2B2), // Ash color

        child: Icon(Icons.search,color: Colors.white),  // Icon for the FAB (search icon)
        tooltip: 'Search',  // Tooltip text that appears when the user hovers over the FAB
      ),
    );
  }
  ...
  Widget buildIndicator() => AnimatedSmoothIndicator(
    ...
    count: 5,
    effect: SlideEffect(
        dotWidth: 15, dotHeight: 20, activeDotColor: Colors.red),
  );
}
